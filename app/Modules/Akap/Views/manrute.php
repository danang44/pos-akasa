                        ...
                        <table id="datatable" class="table table-theme table-row v-middle">
                            <thead>
                                <tr>
                                    ...
                                    <th><span>Deskripsi Rute</span></th>
                    ...
                    <div class="card-body">
                        <form data-plugin="parsley" data-option="{}" id="form" novalidate>
                            ...
                            <?= csrf_field(); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="kode_trayek">Kode Trayek</label>
                                        <input type="text" class="form-control" id="kode_trayek" name="kode_trayek"
                                            placeholder="Kode Trayek" value="" required>
                                ...
                                <div class="col-md-6">
                                 ...
                                 <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="rute">Deskripsi Rute</label>
...
<script type="text/javascript">
    ...
    function datatableColumn() {
        let columns = [
            ...
            { data: "kode_trayek", orderable: true },
            { data: "kor", orderable: true },
            { data: "group_nm", orderable: true },
            { data: "name", orderable: true },
            { data: "rute", orderable: true },
