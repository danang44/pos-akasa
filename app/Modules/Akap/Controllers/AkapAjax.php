...
class AkapAjax extends BaseController
{
    private $akapModel;
    private $armadaTipe;
    ...
    function kor_select_get(){
        ...
        $query = "SELECT a.kor as id, concat(a.kor,' - ', a.group_nm) as 'text', a.color, a.group_nm from m_routes a where a.is_deleted='0' and a.jenroute='AKAP' ".$bptd." ";
