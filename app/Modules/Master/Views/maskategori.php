                    ...
                    <div class="table-responsive" style="padding:7px;">
                        <table id="datatable" class="table table-theme table-row v-middle">
                            <thead>
                                <tr>
                                    <th><span>#</span></th>
                                    <th><span>Jenis Kategori</span></th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        ...
                        <div class="card-body">
                            <form data-plugin="parsley" data-option="{}" id="form" novalidate>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label" for="jenroute">Jenis Kategori</label>
                                            <input type="text" class="form-control" id="kategori" name="kategori" required autocomplete="off" placeholder="Tentukan nama Kategori">
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        coreEvents.insertHandler = {
            placeholder: 'Berhasil menyimpan kategori',
            afterAction: function(result) {
            }
        }

        coreEvents.editHandler = {
            placeholder: 'Berhasil mengubah kategori',
            afterAction: function(result) {}
        }

        coreEvents.deleteHandler = {
            placeholder: 'Berhasil menghapus kategori',
        ...
        coreEvents.placeholder = 'Cari kategori';
