...
<script type="text/javascript">
    $(function() {
        ...
        $(document).on('click', 'body:not(.dropdown-items)', function() {
            ...
            .on('click', '.edit-point', function(e) {
                ...
                if (T.points[index] !== undefined) {
                    $(this).closest('.item-point').find('input.input-point').addClass('edited');
                    $(this).closest('.item-point').find('input.input-point').focus();
                }
    ...
    const saveForm = (data) => {
        ...
        $.ajax({
            type: "POST",
            url: Dashboard.baseUrl + '/perintis/action/mantrayek_save',
            data: data,
            dataType: "json",
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#input-route-code").select2({
            ...
            ajax: {
                url: Dashboard.baseUrl + '/perintis/ajax/kor_select_get',
                dataType: 'json',
                quietMillis: 500,
                delay: 500,
                data: function(param) {
