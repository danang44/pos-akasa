                        ...
                        <div class="card-body">
                            <form data-plugin="parsley" data-option="{}" id="form" novalidate>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="name">Nama Trayek</label>
                                            <input type="text" class="form-control" id="name" name="name" placeholder="Tentukan nama Trayek" value="" required>
                                            <div class="invalid-feedback">
                                                Tentukan nama Trayek
                                            </div>
                                        </div>
                                    </div>
                                    <!-- <div class="col-md-6">
