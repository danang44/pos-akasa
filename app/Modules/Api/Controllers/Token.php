...
class Token extends BaseController
{
    ...
    public function signature(){
        ...
        if($signature != ""){
            ...
            $response = ["success" => true, "message" => "Invalid Client", "signature" => null];
        }
    ...
    public function jwt(){
        ...
        if($verify){
            ...
            $response = ["success" => false, "message" => "Invalid Signature", "token" => null];
        }
    ...
    private function _generateJwtToken($ipAddress){
        $issuedAt = time();
        $expTime = $issuedAt + (60 * 60 ); # 60 detik * 60 untuk 1 jam
