    ...
    var sourceSatpelData = {
        ...
        "Satuan Kerja" : {
            ...
            "layer" : L.markerClusterGroup({
                ...
                iconCreateFunction: function(cluster4) {
                  return L.divIcon({ 
                    html: '<div class="data-badge-satuan-kerja" data-badge="'+cluster4.getChildCount()+' Satuan Kerja"></div>' });
                }
            })
        },
        "Perhubungan Laut" : {
            ...
            "layer" : L.markerClusterGroup({
                ...
                iconCreateFunction: function(cluster4) {
                  return L.divIcon({ 
                    html: '<div class="data-badge-perhubungan-laut" data-badge="'+cluster4.getChildCount()+' Perhubungan Laut"></div>' });
                }
            })
        },
        "Perhubungan Udara" : {
            ...
            "layer" : L.markerClusterGroup({
                ...
                iconCreateFunction: function(cluster4) {
                  return L.divIcon({ 
                    html: '<div class="data-badge-perhubungan-udara" data-badge="'+cluster4.getChildCount()+' Perhubungan Udara"></div>' });
                }
            })
        },
        "Perkeretaapian" : {
            ...
            "layer" : L.markerClusterGroup({
                ...
                iconCreateFunction: function(cluster4) {
                  return L.divIcon({ 
                    html: '<div class="data-badge-perkeretaapian" data-badge="'+cluster4.getChildCount()+' Kereta Api"></div>' });
                }
            })
        },
        "Satuan Pelayanan" : {
            ...
            "layer" : L.markerClusterGroup({
                ...
                iconCreateFunction: function(cluster4) {
                  return L.divIcon({ 
                    html: '<div class="data-badge-satuan-pelayanan" data-badge="'+cluster4.getChildCount()+' Satuan Pelayanan"></div>' });
                }
            })
        }
    }
  ...
  //       });
    ...
    function loadRoute(item){
        $.each($.parseJSON(item.points),function(index2,point){
            ...
            polylineData[item.id] = L.polyline(latlng3, {
                contextmenu: true,
    ...
    function moveBusStop(e){
        Swal.fire({
            ...
            var vbs_lat = e.target.options.data.bs_lat;
            var vbs_lng = e.target.options.data.bs_lng;
            if(willsave.value) {
                Dashboard.saveLoading();
