                        ...
                        <div class="card-body">
                            <form data-plugin="parsley" data-option="{}" id="form" novalidate>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="group_nm">Grup Trayek</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="kor">Kode Trayek</label>
                                            <input type="text" class="form-control" id="kor" name="kor" placeholder="Tentukan kode Trayek" value="" required>
                                            <div class="invalid-feedback">
                                                Tentukan kode Trayek
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="name">Nama Trip</label>
                                            <input type="text" class="form-control" id="name" name="name" placeholder="Tentukan nama Trip" value="" required>
                                            <div class="invalid-feedback">
                                                Tentukan nama Trip
                                            </div>
                                        </div>
                                    ...
                                    <!-- <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="jenroute">Jenis Trayek</label>
                                        <input type="text" class="form-control" id="jenroute" name="jenroute"
                                            placeholder="Tentukan jenis Trayek" value="" required>
                                        <div class="invalid-feedback">
                                            Tentukan jenis Trayek
                                        </div>
                                    </div>
                                </div> -->
                                    <div class="col-md-6">
                                        <div class="row mb-3">
                                            <label class="form-label" for="color">Warna Trayek</label>
                                            <div class="col-11 pe-0">
                                                <input type="color" class="form-control" id="color" name="color" placeholder="Tentukan jenis Trayek" required>
                                                <div class="invalid-feedback">Tentukan warna Trayek</div>
                                            </div>
                                            <div class="col-1">
                                                <a onclick="$('#color').val(randomColor());" class="btn btn-sm btn-outline-dark" title="Warna acak"><i class="fas fa-dice"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        coreEventsPage.insertHandler = {
            placeholder: 'Berhasil menyimpan Trayek',
        ...
        coreEventsPage.deleteHandler = {
            placeholder: 'Berhasil menghapus Trayek',
