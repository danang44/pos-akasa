                        ...
                        <div class="card-body">
                            <form data-plugin="parsley" data-option="{}" id="form" novalidate>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label" for="jenroute">Jenis Pelayanan</label>
                                            <input type="text" class="form-control" id="jenroute" name="jenroute" required autocomplete="off" placeholder="Tentukan nama jenis pelayanan">
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        coreEvents.insertHandler = {
            placeholder: 'Berhasil menyimpan jenis pelayanan',
            afterAction: function(result) {}
        }

        coreEvents.editHandler = {
            placeholder: 'Berhasil mengubah jenis pelayanan',
            afterAction: function(result) {}
        }

        coreEvents.deleteHandler = {
            placeholder: 'Berhasil menghapus jenis pelayanan',
        ...
        coreEvents.placeholder = 'Cari jenis pelayanan';
