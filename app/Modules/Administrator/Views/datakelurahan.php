                            ...
                            <?= csrf_field(); ?>
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12 mb-3">
                                        ...
                                        <select class="form-control sel2" id="idkabkota" required>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-12 mb-3">
                                    ...
                                    <div class="form-group col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="kel" name="kel" maxlength="100"
                                            required autocomplete="off" placeholder="Tentukan nama kelurahan">
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        coreEvents.insertHandler = {
            placeholder: 'Berhasil menyimpan data kelurahan',
        ...
        coreEvents.deleteHandler = {
            placeholder: 'Berhasil menghapus data kelurahan',
    ...
    function datatableColumn() {
        let columns = [
            ...
            { data: "namakabkota", orderable: true },
            { data: "namakec", orderable: true },
            { data: "kel", orderable: true },
            {
