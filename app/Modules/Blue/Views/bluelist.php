                        ...
                        <div class="row mb-3">
                            <div class="col-lg-5 col-md-5 col-sm-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-md date" name="date-start" id="date-start" placeholder="Masa Berlaku Mulai" required autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-5 col-md-5 col-sm-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-md date" name="date-end" id="date-end" placeholder="Masa Berlaku Selesai" required autocomplete="off">
                                </div>
                            </div>
                        </div>
        ...
        let columns = [
                ...
                {data: "date", orderable: false},
                {
                    ...
                    render: function (a, type, data, index) {
                        ...
                        button += '<button class="btn btn-sm btn-outline-primary blue-lite mr-2" data-id="'+data.no_registrasi_kendaraan+'" data-toggle="tooltip" data-placement="top" title="Blue Lite">\
                        ...
                        button += '<button class="btn btn-sm btn-outline-primary blue-test-period mr-2" data-id="'+data.no_registrasi_kendaraan+'" data-toggle="tooltip" data-placement="top" title="Blue Test Period">\
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye mx-2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>\
                            </button>\
                            ';

                        button += '<button class="btn btn-sm btn-outline-primary blue-last mr-2" data-id="'+data.no_registrasi_kendaraan+'" data-toggle="tooltip" data-placement="top" title="Blue Last">\
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye mx-2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>\
                            </button>\
                            ';
